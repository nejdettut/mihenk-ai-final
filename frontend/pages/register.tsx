...
export default function Register() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError('Google ile giriş başarısız: ' + (err?.message || 'Tekrar deneyin.'))
      ...
      <div className="flex items-center justify-center py-16 px-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">İlk 20 analiz tamamen ücretsiz</p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl px-4 py-3 hover:bg-gray-50 transition font-medium text-gray-700 mb-4 disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-gray-400">veya e-posta ile</span>
            <div className="flex-1 border-t border-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Okul Adı <span className="text-gray-400">(opsiyonel)</span>
              </label>
              <input
                type="text"
                value={schoolName}
